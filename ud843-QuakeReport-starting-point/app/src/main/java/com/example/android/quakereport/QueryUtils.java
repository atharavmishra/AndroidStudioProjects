...
public final class QueryUtils {
     ...
     */
    public static ArrayList<Word> extractEarthquakes(String requestUrl)  {
        ...
        ArrayList<Word> earthquake = extractFeatureFromJson(jsonResponse);
    ...
    private static ArrayList<Word> extractFeatureFromJson(String earthquakeJSON) {
        ...
        try {
            ...
            for (int i = 0; i < features.length(); i++) {
                ...
                String mag1=String.valueOf(mag);
                ...
                String tim= timeFormat.format(dateObject);

                earthquakes.add( new Word(mag1,place,dateToDisplay,tim,url));
